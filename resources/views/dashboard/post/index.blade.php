<x-admin-layout>
    <x-slot name="content">
        ...
        {{-- Post Index Contents --}}
        <div class="">
            <x-link href="{{ route('post.create') }}" class="inline-block mb-6 bg-blue-300">Create New Post</x-link>
        </div>
                    ...
                    @forelse ($posts as $post)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td scope="row"
                                ...
                                @if ($post->is_featured)
                                    <span
                                        class="bg-yellow-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800">Featured</span>
                                @endif
                            ...
                            <td scope="row"
                                ...
                                <a href="{{ route('post.edit', $post) }}"
                                    class="bg-green-100 text-green-800 text-md  mr-2 px-2.5 py-0.5 rounded dark:bg-green-200 dark:text-green-900 hover:text-white hover:bg-slate-700">Edit</a>
                            </td>
                        </tr>
                    @empty
                    @endforelse
